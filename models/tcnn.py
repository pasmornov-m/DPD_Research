    ...
    def __init__(self, hidden_channels):
        ...
        self.network = nn.Sequential(
            ...
            nn.Conv1d(self.hidden_channels, 
                      ...
                      self.kernel_size,
                      stride=self.stride, 
                      padding=(self.kernel_size-3)*self.dilation, 
            ...
            nn.Conv1d(self.hidden_channels, 
                      ...
                      self.kernel_size,
                      stride=self.stride, 
                      padding=(self.kernel_size-3)*self.dilation*2, 
            ...
            nn.Conv1d(self.hidden_channels, 
                      ...
                      self.kernel_size,
                      stride=self.stride, 
                      padding=(self.kernel_size-3)*self.dilation*4, 
            ...
            nn.Conv1d(self.hidden_channels, 
                      ...
                      self.kernel_size, 
                      stride=self.stride,
                      padding=(self.kernel_size-3)*self.dilation*8, 
